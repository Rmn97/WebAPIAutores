...
namespace WebAPIAutores.Utilidades
{
    public class HATEOASAutorFilterAttribute: HATEOASFiltroAttribute
    {
            ...
            ResultExecutionDelegate next)
        {
            ...
            //var modelo = resultado.Value as AutorDTO ?? throw new ArgumentNullException("Se esperaba una instacia de autor");
            var autorDTO = resultado.Value as AutorDTO; 
            
            if (autorDTO == null)
            {
                var autoresDTO = resultado.Value as List<AutorDTO> ??
                    throw new ArgumentException("Se esperaba una instancia de AutorDTO o Lista de AutorDTO");
